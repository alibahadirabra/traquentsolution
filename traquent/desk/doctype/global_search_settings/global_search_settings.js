...
traquent.ui.form.on("Global Search Settings", {
	refresh: function (frm) {
		traquent.realtime.on("global_search_settings", (data) => {
			if (data.progress) {
		...
		frm.add_custom_button(__("Reset"), function () {
			traquent.call({
				method: "traquent.desk.doctype.global_search_settings.global_search_settings.reset_global_search_settings_doctypes",
				callback: function () {
					traquent.show_alert({
