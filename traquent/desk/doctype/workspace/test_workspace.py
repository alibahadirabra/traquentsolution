...
class TestWorkspace(IntegrationTestCase):
	...
	def tearDown(self):
		traquent.db.delete("Workspace", {"module": "Test Module"})
		traquent.db.delete("DocType", {"module": "Test Module"})
		traquent.delete_doc("Module Def", "Test Module")
...
def create_workspace(**args):
	workspace = traquent.new_doc("Workspace")
