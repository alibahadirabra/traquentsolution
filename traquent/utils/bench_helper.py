...
def get_sites(site_arg: str) -> list[str]:
	...
	elif (site := traquent.read_file("currentsite.txt")) and site.strip():
		click.secho(
			dedent(
				f"""
...
def get_apps():
	return traquent.get_all_apps(with_internal_apps=False, sites_path=".")


if __name__ == "__main__":
	if not traquent._dev_server:
