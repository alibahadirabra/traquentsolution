...
from traquent.utils import format_date, today
from traquent.utils.goal import get_monthly_goal_graph_data, get_monthly_results
...
class TestGoal(IntegrationTestCase):
	...
	def test_get_monthly_goal_graph_data(self):
		...
		docname = traquent.get_list("Event", filters={"subject": ["=", "_Test Event 1"]})[0]["name"]
		traquent.db.set_value("Event", docname, "description", 1)
