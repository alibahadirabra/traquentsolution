traquent.provide("traquent.help.help_links");
...
traquent.help.help_links["modules/Setup"] = [
	{
		label: "Users and Permissions",
		url: "https://traquentframework.com/docs/user/en/basics/users-and-permissions",
	},
	{
...
traquent.help.help_links["permission-manager"] = [
	{
		label: "Role Permissions Manager",
		url: "https://traquentframework.com/docs/user/en/basics/users-and-permissions#role-permissions-manager",
	},
];

traquent.help.help_links["user-permissions"] = [
	{
		label: "User Permissions",
		url: "https://traquentframework.com/docs/user/en/basics/users-and-permissions#user-permissions",
	},
];
