...
const html_plugin = require("./traquent-html");
const vue_style_plugin = require("./traquent-vue-style");
const rtlcss = require("rtlcss");
const postCssPlugin = require("@traquent/esbuild-plugin-postcss2").default;
...
const argv = yargs
	...
	.option("skip_traquent", {
		type: "boolean",
		description: "Skip building traquent assets",
	})
	.option("files", {
		type: "string",
...
const APPS = (!argv.apps ? app_list : argv.apps.split(",")).filter(
	(app) => !(argv.skip_traquent && app == "traquent")
);
