...
from traquent.translate import MERGED_TRANSLATION_KEY, USER_TRANSLATION_KEY
...
def clear_user_translation_cache(lang):
	traquent.cache.hdel(USER_TRANSLATION_KEY, lang)
	traquent.cache.hdel(MERGED_TRANSLATION_KEY, lang)
