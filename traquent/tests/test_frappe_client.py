...
class TesttraquentClient(IntegrationTestCase):
	...
	def test_update_child_doc(self):
		...
		traquent.db.delete("Communication Link", {"link_doctype": "Contact"})
		traquent.db.delete("Event", {"subject": "Sing a song of sixpence"})
		traquent.db.delete("Event Participants", {"reference_doctype": "Contact"})
		traquent.db.commit()
