...
from traquent.utils import cint, cstr, get_system_timezone
...
class TokenCache(Document):
	...
	def get_auth_header(self):
		...
		raise traquent.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			traquent.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
	...
	def get_expires_in(self):
		...
		modified = traquent.utils.get_datetime(self.modified)
