...
import traquent
from traquent.modules.patch_handler import get_all_patches, parse_as_configfile
from traquent.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = traquent._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.bench_path = traquent.utils.get_bench_path()
