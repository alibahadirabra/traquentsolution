...
from traquent.utils import cint, convert_utc_to_system_timezone
from traquent.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> traquent._dict:
	...
	if current_job and not current_job.startswith(traquent.local.site):
		current_job = None
