...
from traquent.defaults import clear_default, set_default
...
class Language(Document):
	...
	def on_update(self):
		traquent.cache.delete_value("languages_with_name")
		traquent.cache.delete_value("languages")
	...
	def update_user_defaults(self):
		...
		should be updated.
		"""
		users = traquent.get_all("User", filters={"language": self.name}, pluck="name")
