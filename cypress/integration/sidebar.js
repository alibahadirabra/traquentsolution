...
context("Sidebar", () => {
	before(() => {
		...
		return cy
			...
			.its("traquent")
			.then((traquent) => {
				return traquent.call("traquent.tests.ui_test_helpers.create_blog_post");
			});
	});

	it("Verify attachment visibility config", () => {
		cy.call("traquent.tests.ui_test_helpers.create_todo", {
	...
	it("Verify attachment accessibility UX", () => {
		cy.call("traquent.tests.ui_test_helpers.create_todo_with_attachment_limit", {
