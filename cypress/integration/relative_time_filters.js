...
// 		cy.window().its('traquent').then(traquent => {
// 			traquent.call("traquent.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/traquent.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/traquent.model.utils.user_settings.save')
