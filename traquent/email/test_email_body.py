...
import traquent
from traquent import safe_decode
from traquent.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from traquent.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from traquent.email.receive import Email
...
<div>
	...
	<img embed="assets/traquent/images/traquent-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/traquent/images/traquent-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = traquent.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="traquent-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/traquent/images/traquent-favicon.svg" alt="test" />
