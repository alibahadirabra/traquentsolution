import traquent
from traquent.core.doctype.log_settings.log_settings import clear_log_table
from traquent.utils import add_to_date, today
...
def execute():
	...
	ref: https://github.com/traquent/traquent/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(traquent.db.exists(doctype, {"modified": ("<", threshold)}))


def get_current_setting(fieldname):
	try:
		return traquent.db.get_single_value("Log Settings", fieldname)
	except Exception:
