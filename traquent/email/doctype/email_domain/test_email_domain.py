...
class TestDomain(IntegrationTestCase):
	...
	def tearDown(self):
		traquent.delete_doc("Email Account", "Test")
		traquent.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = traquent.get_doc("Email Domain", "test.com")
		mail_account = traquent.get_doc("Email Account", "Test")
