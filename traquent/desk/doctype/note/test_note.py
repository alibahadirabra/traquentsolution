# Copyright (c) 2015, traquent Technologies Pvt. Ltd. and Contributors and Contributors
...
class TestNote(IntegrationTestCase):
	def insert_note(self):
		traquent.db.delete("Version")
		traquent.db.delete("Note")
		traquent.db.delete("Note Seen By")

		return traquent.get_doc(doctype="Note", title="test note", content="test note content").insert()
	...
	def test_version(self):
		...
		version = traquent.get_doc("Version", dict(docname=note.name))
