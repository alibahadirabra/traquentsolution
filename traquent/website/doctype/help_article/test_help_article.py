...
class TestHelpArticle(IntegrationTestCase):
	...
	def setUpClass(cls) -> None:
		cls.help_category = traquent.get_doc(
			{
		...
		cls.help_article = traquent.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from traquent.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		traquent.delete_doc(cls.help_article.doctype, cls.help_article.name)
		traquent.delete_doc(cls.help_category.doctype, cls.help_category.name)
