...
from traquent.core.doctype.data_import.test_importer import create_doctype_if_not_exists
...
class TestExporter(IntegrationTestCase):
	...
	def test_exports_specified_fields(self):
		if not traquent.db.exists(doctype_name, "Test"):
			...
			doc = traquent.get_doc(doctype_name, "Test")
	...
	def test_export_csv_response(self):
		...
		self.assertEqual(traquent.response["doctype"], doctype_name)
